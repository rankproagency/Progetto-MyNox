...
const ALLOWED_KEYS = ['can_manage_events', 'can_manage_tables', 'can_view_analytics', 'can_view_participants', 'can_scan_tickets', 'can_manage_promos', 'can_access_crm', 'can_manage_extras'] as const;
