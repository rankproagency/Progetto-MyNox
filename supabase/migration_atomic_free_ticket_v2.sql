-- Fix: create_free_tickets_atomic ignorava ticket_types.max_per_account e usava 5 hardcoded.
-- Ora legge il limite dal DB e usa 5 solo come fallback se il campo è NULL.
...
BEGIN
  IF p_ticket_type_id IS NOT NULL THEN
    ...
    -- Legge max_per_account dal DB; fallback a 5 se NULL
    SELECT COALESCE(max_per_account, 5) INTO v_limit
    ...
    IF v_count + p_quantity > v_limit THEN
